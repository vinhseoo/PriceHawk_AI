...
export default function LoginPage() {
  ...
  const handleGoogleLogin = () => {
    // Show intent — real integration requires Google Identity Services SDK
    toast({
      title: 'Google OAuth',
      description: 'Đang kết nối Google... (cần cấu hình Google Client ID)',
    });
    googleLogin(
      { idToken: 'placeholder-google-id-token' },
      {
        onError: () => {
          toast({
      ...
      <div className="w-full max-w-md">
        <div className="rounded-2xl bg-white p-8 shadow-lg border border-gray-100">
          ...
          <div className="mb-6 text-center">
            ...
            <h1 className="mt-2 text-2xl font-bold text-gray-900">Đăng nhập</h1>
            <p className="mt-1 text-sm text-gray-500">
              Chào mừng trở lại với PriceHawk AI
            </p>
          </div>
          ...
          >
            ...
            {isGooglePending ? 'Đang kết nối...' : 'Đăng nhập với Google'}
          </button>
