package com.pricehawk.common.constants;
...
public final class MessageQueueConstants {
    ...
    // Exchanges
    public static final String SCRAPE_EXCHANGE = "pricehawk.scrape";
    public static final String ANALYSIS_EXCHANGE = "pricehawk.analysis";
    public static final String PRICE_EXCHANGE = "pricehawk.price";
